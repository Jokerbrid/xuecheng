...
public interface MqMessageMapper extends BaseMapper<MqMessage> {
    ...
    List<MqMessage> selectListByShardIndex(@Param("shardTotal") int shardTotal, @Param("shardindex") int shardindex, @Param("messageType") String messageType, @Param("count") long count);
