...
//        mqMessage.setExecuteNum(0);
    ...
    public int completed(long id) {
        ...
        if(update>0){
            ...
            MqMessageHistory messageHistory = mqMessageHistoryMapper.selectById(mqMessageHistory);
            if(messageHistory!=null){
                mqMessageHistoryMapper.updateById(mqMessageHistory);
            }else{
